        ...
        <div class="flex justify-center align-middle flex-col w-3/4">
            <div class="w-full px-12 py-14 shadow-md bg-white">
                <div class="my-4">
                    ...
                    <input type="text" class="shadow-inner bg-gray-100 w-full rounded-md">
                </div>
                <div class="my-4">
            ...
            <div class="flex justify-end my-4">
                <button class="bg-slate-950 border py-2 px-4 rounded-md text-base text-white text-center leading-6 font-bold">Lanjutkan</button>
            </div>
        </div>
    </main>
</body>
