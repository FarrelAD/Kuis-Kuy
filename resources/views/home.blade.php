...
<body class="flex justify-center items-center flex-col bg-gray-100 h-screen">
    ...
    <template id="instructor-card">
        ...
        <input type="password" name="password" id="input-password" placeholder="Password" class="shadow-inner rounded-md bg-gray-100 w-full px-4 py-2 my-4">

        <button onclick="window.location.href='/dashboard'" class="bg-slate-950 border py-2 my-2 text-white text-center rounded-md w-full">Masuk</button>
    </template>
